...
wget https://github.com/subspace/subspace/releases/download/gemini-3g-2023-nov-07/subspace-farmer-ubuntu-x86_64-skylake-gemini-3g-2023-nov-07

wget https://github.com/subspace/subspace/releases/download/gemini-3g-2023-nov-07/subspace-node-ubuntu-x86_64-skylake-gemini-3g-2023-nov-07

sudo mv subspace-node-ubuntu-x86_64-skylake-gemini-3g-2023-nov-07 /usr/local/bin/subspace-node

sudo mv subspace-farmer-ubuntu-x86_64-skylake-gemini-3g-2023-nov-07 /usr/local/bin/subspace-farmer
...
[Service]
User=$USER
ExecStart=subspace-node --chain gemini-3g --blocks-pruning 256 --state-pruning archive-canonical --no-private-ipv4 --validator --name '$NODE_NAME'
Restart=always
RestartSec=10
LimitNOFILE=10000
