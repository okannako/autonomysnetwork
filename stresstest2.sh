...
sudo mv subspace-node-ubuntu-x86_64-gemini-2a-2022-sep-06 /usr/local/bin/subspace-node

sudo mv subspace-farmer-ubuntu-x86_64-gemini-2a-2022-sep-06 /usr/local/bin/subspace-farmer
