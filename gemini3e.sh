...
wget https://github.com/subspace/subspace-cli/releases/download/v0.5.1-alpha-2/subspace-cli-ubuntu-x86_64-skylake-v0.5.1-alpha-2
chmod +x subspace-cli-ubuntu-x86_64-skylake-v0.5.1-alpha-2
sleep 1
