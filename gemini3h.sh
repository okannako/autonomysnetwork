...
wget https://github.com/subspace/pulsar/releases/download/v0.8.0-alpha/pulsar-ubuntu-x86_64-skylake-v0.8.0-alpha
chmod +x pulsar-ubuntu-x86_64-skylake-v0.8.0-alpha
sleep 1
