...
sudo mv subspace-node-ubuntu-x86_64-gemini-1b-2022-jun-10 /usr/local/bin/subspace-node

echo "=================================================="

echo -e "\e[1m\e[32m6. Moving farmer to /usr/local/bin/subspace-farmer ... \e[0m" && sleep 1
sudo mv subspace-farmer-ubuntu-x86_64-gemini-1b-2022-jun-10 /usr/local/bin/subspace-farmer
